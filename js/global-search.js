...
createTemplateByProject = function(table, limited, callback) {
  ...
  createInfoWindow = function(projectId, scriptTemplateId, tableName) {
    ...
    detail = limited ? "" : "<p>Tested {{content.data.diseasetested}} as {{content.data.diseasedetected}} (Fatal: {{content.data.fatal}})</p><p>Sample was taken in YYYY of a Living|Preserved specimen</p>";
