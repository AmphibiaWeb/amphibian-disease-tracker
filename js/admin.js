...
loadEditor = function(projectPreload) {
  ...
  editProject = function(projectId) {
    ...
    verifyLoginCredentials(function(credentialResult) {
      ...
      return $.post(adminParams.apiTarget, args, "json").done(function(result) {
        var affixOptions, anuraState, authorData, bb, cartoParsed, caudataState, centerPoint, collectionRangePretty, conditionalReadonly, createMapOptions, creation, d1, d2, deleteCardAction, e, error, error1, error2, error3, error4, googleMap, gymnophionaState, html, i, icon, l, len, len1, len2, m, mapHtml, mdFunding, mdNotes, month, monthPretty, months, monthsReal, noteHtml, o, poly, project, publicToggle, ref, ref1, ref2, ref3, ref4, ta, topPosition, uid, userHtml, year, yearPretty, years, yearsReal;
        try {
...
saveEditorData = function() {
  ...
  $.post("" + uri.urlString + adminParams.apiTarget, args, "json").done(function(result) {
    return console.info("Save result: server said", result);
  }).error(function(result, status) {
