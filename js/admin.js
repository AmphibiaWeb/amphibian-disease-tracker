...
loadEditor = function() {
  ...
  editProject = function(projectId) {
    ...
    verifyLoginCredentials(function(credentialResult) {
      ...
      return $.post(adminParams.apiTarget, args, "json").done(function(result) {
        var affixOptions, anuraState, cartoParsed, caudataState, conditionalReadonly, e, error, gymnophionaState, html, icon, l, len, popManageUserAccess, project, ref, ref1, topPosition, userHtml;
        try {
