...
loadCreateNewProject = function() {
  ...
  $("#data-encumbrance-toggle").on("iron-change", function() {
    var buttonLabel;
    buttonLabel = p$("#data-encumbrance-toggle").checked ? "<iron-icon icon=\"social:public\"></iron-icon> Save Data &amp; Create Public Project" : "<iron-icon icon=\"icons:lock-open\"></iron-icon> Save Data &amp; Create Private Project";
