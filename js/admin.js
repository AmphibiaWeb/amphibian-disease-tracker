...
loadEditor = function() {
  ...
  editProject = function(projectId) {
    ...
    verifyLoginCredentials(function(credentialResult) {
      ...
      return $.post(adminParams.apiTarget, args, "json").done(function(result) {
        var affixOptions, anuraState, cartoParsed, caudataState, conditionalReadonly, e, error, gymnophionaState, html, icon, l, len, popManageUserAccess, project, publicToggle, ref, ref1, topPosition, userHtml;
        try {
...
getProjectCartoData = function(cartoObj) {
   ...
   */
  var cartoData, cartoTable, html, l, len, mapHtml, point, poly, ref, ref1, usedPoints;
  ...
  if (((ref = cartoData.bounding_polygon) != null ? ref.paths : void 0) != null) {
