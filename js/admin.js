...
loadEditor = function(projectPreload) {
  ...
  editProject = function(projectId) {
    ...
    verifyLoginCredentials(function(credentialResult) {
      ...
      return $.post(adminParams.apiTarget, args, "json").done(function(result) {
        var affixOptions, anuraState, cartoParsed, caudataState, conditionalReadonly, deleteCardAction, e, error, googleMap, gymnophionaState, html, icon, l, len, len1, m, mapHtml, noteHtml, point, poly, popManageUserAccess, project, publicToggle, ref, ref1, ref2, ref3, topPosition, usedPoints, userHtml;
        try {
