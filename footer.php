    <footer class="row">
      ...
      <div class="col-md-1 col-xs-3">
        <paper-icon-button icon="icons:mail" class="click" data-href="mailto:amphibiaweb+data@berkeley.edu" data-toggle="tooltip" title="Email" data-newtab="true"></paper-icon-button>
      </div>
