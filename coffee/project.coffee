...
renderPublicMap = (projectData = publicData) ->
  ...
  try
    ...
    <div class="row" id="public-map">
      ...
      <google-map id="transect-viewport" latitude="#{projectData.lat}" longitude="#{projectData.lng}" fit-to-markers map-type="hybrid" disable-default-ui zoom="#{zoom}" class="col-xs-12 col-md-9 col-lg-6 center-block clearfix">
            #{mapHtml}
      </google-map>
    </div>
    """
